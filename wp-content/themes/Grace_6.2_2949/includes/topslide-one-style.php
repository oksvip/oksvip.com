<div class="top-content">
	<div class="container">
		<div class="row">
			<div class="owl-carousel top-slide <?php echo $GLOBALS['wow_slide'];?>">
							...
							<div class="slider-image">
								<a href="<?php the_permalink(); ?>"  target="_blank" title="<?php the_title();?>">
									...
									<?php }elseif( suxingme('suxingme_timthumb')){ ?>
										<img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo post_thumbnail_src(); ?>&h=430&w=820&zc=1"  alt="<?php the_title(); ?>">
									<?php }else{ ?>
