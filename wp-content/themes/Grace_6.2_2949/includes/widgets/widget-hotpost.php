				...
				while ( $hot_posts->have_posts() ) :$hot_posts->the_post(); ?>
					<li>
						<a class="img" href="<?php the_permalink(); ?>"	title="<?php the_title(); ?>">
							...
							<div class="title">
								<div class="entry-meta"><span><i class="icon-comment-inv-alt2"></i> <?php echo get_comments_number('0','1','%');?></span><span><i class="icon-clock-1"></i> <?php echo timeago( get_gmt_from_date(get_the_time('Y-m-d G:i:s')) ); ?></span></div>
