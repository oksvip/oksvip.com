				...
				<?php if($i == 1){ ?>
					<li class="one">
						...
						<div class="recent-posts-title">
							<span class="info" ><i class="icon-clock-1"></i> <?php echo timeago( get_gmt_from_date(get_the_time('Y-m-d G:i:s')) ); ?></span>
							<h4 class="title" ><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h4>
						</div>
					</li>
				<?php }else{ ?>
					<li>
						<div class="recent-posts-img"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
							<?php if( suxingme('suxingme_timthumb_lazyload',true)) { ?>
