...
<div id="footer" class="one-s-footer">
	<div class="container">
		<div class="row">
			...
			<div class="footer-copyright">Copyright © 2015-<?php echo intval(date('Y')); ?> <a class="site-link" href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>" rel="home"><?php bloginfo('name'); ?></a> <?php if( suxingme('suxingme_beian') ) { ?> <a href="http://www.miitbeian.gov.cn" rel="external nofollow" target="_blank"><?php echo suxingme('suxingme_beian'); ?></a><?php } ?> <?php if( suxingme('suxingme_statistics_code') ) { ?><?php echo suxingme('suxingme_statistics_code'); ?><?php } ?>
			<br/>Copyright © 2017 · Power By <a href="https://www.oksvip.com" target="_blank" rel="nofollow">www.oksvip.com</a> 
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="copyright-footer">
					...
					<?php } ?>
<!-- · Powered By WordPress · Theme By <a href="http://www.suxing.me" target="_blank">Suxing</a> --> 
				     </p>
				</div>
