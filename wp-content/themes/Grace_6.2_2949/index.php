<?php get_header();?>
<div id="page-content" <?php if( suxingme('suxing_slide_img_button','index_slide_sytle_1') == 'index_slide_sytle_3' ) { echo 'style="padding-top:110px;"';}?>>
	<?php 
									...
									if( suxingme('suxingme_get_index3') == 'one' ) :
										...
										if( $categories[0] != '' ) :
											foreach ($categories as $cat=>$catid ) { ?>
												<div class="image <?php echo $GLOBALS['wow_3cat'];?>">
