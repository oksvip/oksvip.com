...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      return;
   } else if (wordpress_optimizer_clean_up_optimizer == "1") {
                  ...
                  <form id="ux_frm_manual_clean_up">
                     <div class="form-body">
                        <div class="table-margin-top">
                           ...
                           <input type="button" id="ux_btn_apply" name="ux_btn_apply" class="btn vivid-green" value="<?php echo $cpo_apply; ?>" onclick="bulk_empty_clean_up_optimizer();">
                        </div>
                           ...
                           <tbody class="check-all">
                              <tr>
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("autodraft"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_auto_draft" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(1);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("transient_feed"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_dashboard_transient_feed" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(2);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("unapproved_comments"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_unapproved_comments" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(3);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("comments_meta"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_orphan_comments_meta" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(4);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("posts_meta"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_orphan_posts_meta" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(5);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("relationships"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_orphan_relationships" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(6);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("revision"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_revision" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(7);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("remove_pingbacks"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_remove_pingbacks" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>"onclick="selected_empty_clean_up_optimizer(8);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("remove_transient_options"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_remove_transient_options" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(9);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("remove_trackbacks"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_remove_trackbacks" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(10);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("spam"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_btn_spam_comments" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(11);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("trash"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_trash_comments" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(12);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("draft"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_draft" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(13);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("deleted_posts"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_deleted_posts" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(14);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("duplicated_postmeta"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_duplicated_postmeta" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(15);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("oembed_caches"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_oembed_caches_in_post_meta" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(16);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("duplicated_commentmeta"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_duplicated_comment_meta" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(17);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("orphan_user_meta"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_orphan_user_meta" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(18);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("duplicated_usermeta"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_duplicated_usermeta" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>"onclick="selected_empty_clean_up_optimizer(19);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("orphaned_term_relationships"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_orphaned_term_relationships" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(20);">
                                 </td>
                              </tr>
                              <tr>
                                 <td class="custom-align-chk">
                                 ...
                                 <td class="custom-align">
                                    <label>
                                       <?php echo count_clean_up_optimizer("unused_terms"); ?>
                                    </label>
                                 </td>
                                 <td class="custom-align">
                                    <input type="button" id="ux_chk_unused_terms" class="btn vivid-green btn-align" value="<?php echo $cpo_empty; ?>" onclick="selected_empty_clean_up_optimizer(21);">
                                 </td>
                              </tr>
                           </tbody>
                        </table>
