   ...
   if (!$access_granted) {
      ...
      if ($flag == "1") {
         $wp_admin_bar->add_menu(array
             ...
             "title" => "<img style=\"width:16px; height:16px; vertical-align:middle; margin-right:3px;\" src=" . plugins_url("assets/global/img/icon.png", dirname(__FILE__)) . "> $cpo_clean_up_optimizer",
         ...
         $wp_admin_bar->add_menu(array
             (
             "parent" => "clean_up_optimizer",
             "id" => "cpo_support_forum",
             "title" => $cpo_support_forum,
         ...
         $wp_admin_bar->add_menu(array
             ...
             "id" => "cpo_upgrade",
             "title" => $cpo_upgrade,
             "href" => "https://clean-up-optimizer.tech-banker.com/pricing/",
             "meta" => array('target' => '_blank')
         ));
      }
   }
