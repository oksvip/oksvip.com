...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      if (!defined("wordpress_optimizer_clean_up_optimizer")) {
         define("wordpress_optimizer_clean_up_optimizer", $full_control[1]);
      }
      ...
      if ($flag == "1") {
         ...
         add_submenu_page("cpo_dashboard", $cpo_wp_optimizer, $cpo_dashboard, "read", "cpo_dashboard", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_dashboard");
         add_submenu_page($cpo_dashboard, $cpo_schedule_wp_optimizer, "", "read", "cpo_schedule_optimizer", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_schedule_optimizer");
         add_submenu_page($cpo_dashboard, $cpo_database_optimizer, "", "read", "cpo_db_optimizer", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_db_optimizer");
         add_submenu_page($cpo_dashboard, $cpo_schedule_database_optimizer, "", "read", "cpo_schedule_db_optimizer", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_schedule_db_optimizer");
         add_submenu_page($cpo_dashboard, $cpo_view_records_label, "", "read", "cpo_database_view_records", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_database_view_records");
         add_submenu_page($cpo_dashboard, $cpo_add_new_scheduled_clean_up_label, "", "read", "cpo_add_new_wordpress_schedule", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_add_new_wordpress_schedule");
         add_submenu_page($cpo_dashboard, $cpo_add_new_scheduled_clean_up_label, "", "read", "cpo_add_new_database_schedule", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_add_new_database_schedule");

         add_submenu_page("cpo_dashboard", $cpo_logs_recent_login_logs, $cpo_logs_label, "read", "cpo_login_logs", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_login_logs");
         add_submenu_page($cpo_logs_label, $cpo_logs_live_traffic, "", "read", "cpo_live_traffic", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_live_traffic");
         add_submenu_page($cpo_logs_label, $cpo_logs_visitor_logs, "", "read", "cpo_visitor_logs", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_visitor_logs");

         add_submenu_page("cpo_dashboard", $cpo_cron_core_jobs_label, $cpo_cron_jobs_label, "read", "cpo_core_jobs", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_core_jobs");
         add_submenu_page($cpo_cron_custom_jobs_label, $cpo_cron_custom_jobs_label, "", "read", "cpo_custom_jobs", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_custom_jobs");

         add_submenu_page("cpo_dashboard", $cpo_notifications_setup, $cpo_general_settings_label, "read", "cpo_notifications_setup", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_notifications_setup");
         add_submenu_page($cpo_general_settings_label, $cpo_message_settings, "", "read", "cpo_message_settings", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_message_settings");
         add_submenu_page($cpo_general_settings_label, $cpo_email_templates_label, $cpo_email_templates_label, "read", "cpo_email_templates", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_email_templates");
         add_submenu_page($cpo_general_settings_label, $cpo_roles_capabilities_label, $cpo_roles_capabilities_label, "read", "cpo_roles_and_capabilities", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_roles_and_capabilities");

         add_submenu_page("cpo_dashboard", $cpo_blockage_settings, $cpo_security_settings, "read", "cpo_blockage_settings", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_blockage_settings");
         add_submenu_page($cpo_block_unblock_ip_addresses, $cpo_block_unblock_ip_addresses, "", "read", "cpo_ip_addresses", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_ip_addresses");
         add_submenu_page($cpo_block_unblock_ip_ranges, $cpo_block_unblock_ip_ranges, "", "read", "cpo_ip_ranges", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_ip_ranges");
         add_submenu_page($cpo_block_unblock_countries, $cpo_block_unblock_countries, "", "read", "cpo_block_unblock_countries", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_block_unblock_countries");

         add_submenu_page("cpo_dashboard", $cpo_general_other_settings, $cpo_general_other_settings, "read", "cpo_other_settings", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_other_settings");
         add_submenu_page("cpo_dashboard", $cpo_support_forum, $cpo_support_forum, "read", "https://wordpress.org/support/plugin/wp-clean-up-optimizer", "");
         add_submenu_page("cpo_dashboard", $cpo_system_information_label, $cpo_system_information_label, "read", "cpo_system_information", $check_clean_up_wizard == "" ? "cpo_wizard_optimizer" : "cpo_system_information");
         add_submenu_page("cpo_dashboard", $cpo_upgrade, $cpo_upgrade, "read", "https://clean-up-optimizer.tech-banker.com/pricing/", "");
      }
      ...
      /*
        Function Name: cpo_db_optimizer
        Parameters: No
        Description: This function is used to create database manual Clean Up Menu.
        Created On: 23-09-2016 1:00
        Created By: Tech Banker Team
       */
      ...
      /*
        ...
        Parameters: No
        Description: This function is used to create cpo_notifications_setup menu
        Created On: 23-09-2016 1:00
        Created By: Tech Banker Team
       */
      ...
      /*
        ...
        Parameters: No
        Description: This function is used to create cpo_email_templates
        Created On: 23-09-2016 1:00
        Created By: Tech Banker Team
       */
      ...
      /*
        ...
        Parameters: No
        Description: This function is used to create cpo_roles_and_capabilities
        Created On: 24-09-2016 1:00
        Created By: Tech Banker Team
       */
